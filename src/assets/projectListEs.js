export default [
  {
    ...
    description:
      "<p>Un catálogo online para productos artesanales.</p> <p>El sitio fue diseñado para mostrar en detalle los productos del cliente y dejar entrever su personalidad para crear una experiencia única.</p> <p>Posee el panel administrativo de Wordpress utiliza WooCommerce para la gestión de productos, lo que el cliente cargue aquí es reflejado en el sitio web al instante utilizando la REST API de WooCommerce.</p>",
    tags: ["Tienda", "Vue", "Wordpress", "WooCommerce", "API"],
    images: [
      {
        thumb: require("@/assets/images/projects/lepu/01-thumb.jpg"),
        full: require("@/assets/images/projects/lepu/01.jpg"),
        alt: "Pupe Lepú logo, un conejo dentro de un círculo gris."
      },
      {
        thumb: require("@/assets/images/projects/lepu/02-thumb.jpg"),
        full: require("@/assets/images/projects/lepu/02.jpg"),
        alt: "Varios productos en la tienda."
      },
      {
        thumb: require("@/assets/images/projects/lepu/03-thumb.jpg"),
        full: require("@/assets/images/projects/lepu/03.jpg"),
        alt:
          "La imagen de un zorro amigurumi apoyado sobre un libro y su descripción a la derecha."
      },
      {
        thumb: require("@/assets/images/projects/lepu/04-thumb.jpg"),
        full: require("@/assets/images/projects/lepu/04.jpg"),
        alt: "El panel administrativo mostrando los detalles de los productos."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    description:
      "<p>Una biblioteca virtual que permite llevar cuenta de los libros que leiste.</p> <p>Lo mas importante de este proyecto fue como mostrar toda la información de cada libro en un formato encapsulado. Queria que cada elemento se sintiera natural dentro de ellos y eso me forzó a encontrar soluciones creativas para su implementación.</p>",
    tags: ["Libros", "Vue"],
    images: [
      {
  ...
  {
    name: "Encontrá a Wally",
    links: {
      repo: "https://github.com/totocorvidoni/find-wally",
      live: "https://totocorvidoni.github.io/find-wally/"
    },
    description:
      "<p>Jugá '¿Donde está Wally?' en linea! </p><p> Una aplicación hecha en Vue the permite navegar por la escena buscando los personajes escondidos, desde el servidor una aplicación de Rails se en carga de validar los intentos y mantener las puntuaciones.</p><p> Lo mejor fue deducir como validar los intentos de los jugadores, lo peor fue encontrar a Woof.</p>",
    tags: ["Juego", "Vue", "Rails", "API"],
    images: [
      {
